...
Route::group(['middleware' => ['web'], 'namespace' => 'Admin', 'prefix' => 'admin'], function () {
    ...
    Route::post('group/destroyall',['as'=>'admin.group.destroy.all','uses'=>'GroupController@destroyAll']);
    Route::get('group/{id}/role',['as'=>'admin.group.roles','uses'=>'GroupController@role']);
    Route::post('group/{id}/role',['as'=>'admin.group.roles','uses'=>'GroupController@storeRoles']);
