...
class AdminUserController extends BaseController
{
    ...
    public function edit($id)
    {
        ...
        $hasGroups = DB::table("group_user")->join("groups","group_user.group_id","=","groups.id")->select('name')->get();
        DB::setFetchMode(PDO::FETCH_ASSOC);
        return view('admin.rbac.admin_users.edit', compact('user', 'hasRoles', 'hasGroups'));
    }
